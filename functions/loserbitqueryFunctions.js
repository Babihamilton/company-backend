...
export async function losergetPairCurrencies(chain, pair){
 ...
 * since ---> yyyy-mm-dd
 */
export async function losergetChartData(
  chain,
  pair,
  baseCurrency,
  quoteCurrency,
...
export async function losergetTokenInfo(chain, address) {
...
export async function losergetDexTrades(chain, address) {
...
export async function losergetPairs(chain, address) {
...
export async function losergetNewListedPairs(chain) {
...
// export const losergetTopTrades = async (chain) =>
//   getBitqueryData(
...
//     "{}"
//   );
export async function losergetTopTrades(chain){
...
export const losergetTokenBalances = async (chain, address) => getBitqueryData(
  `{\n  ethereum(network: ${chain}) {\n    address(address: {is: \"${address}\"}) {\n      balances {\n        value\n        currency {\n          address\n          symbol\n          tokenType\n          tokenId\n        }\n      }\n    }\n  }\n}\n`,
  "{}"
)

export const losergetTokenCreated = (chain, address) => getBitqueryData(
  `{\n  ethereum(network: ${chain}) {\n    transactions(txSender: {is: \"${address}\"}) {\n      creates {\n        smartContract {\n          currency {\n            name\n            symbol\n            tokenType\n          }\n          contractType\n        }\n        address\n      }\n    }\n  }\n}\n`,
  "{}"
)

export const losergetOwnershipTrasnferred = (chain, addresses) => getBitqueryData(
  `{\n  ethereum(network: ethereum) {\n    smartContractEvents(\n      smartContractAddress: {in: ${addresses}}\n      smartContractEvent: {is: \"OwnershipTransferred\"}\n    ) {\n      arguments {\n        argument\n        argumentType\n        index\n        value\n      }\n      smartContract {\n        address {\n          address\n        }\n      }\n    }\n  }\n}\n`,
  "{}"
)

export async function losergetPriceVariation (chain, addresses) {
  const query = `{
    ethereum(network: ${chain}) {
...
// export const losergetPriceVariation = (chain, addresses) => {
//   const query = `{
//     ethereum(network: ${chain}) {
//       ${addresses.map((value, index) => `
//         variation${index}: dexTrades(
//           options: { desc: "quotePrice", limit: 5}
...
export const loserget24HourVolume = (chain, pair) => getBitqueryData(
...
export const losergetCirculatedSupply = (chain, currency) => getBitqueryData(
